...
--
-- Host: 127.0.0.1
-- Tempo de geração: 18/07/2026 às 12:50
...
(1, 'Celulares  Android', 'celular/android'),
(2, 'Celulares Iphone', 'celular/iphone'),
(3, 'Celulares Xiaomi', 'celular/xiaomi'),
(4, 'Notebooks', 'notebooks'),
(5, 'MacBook', 'macbook'),
(6, 'Câmeras Vigia', 'cameras/vigia'),
(7, 'Câmeras Foto', 'cameras/Foto'),
(8, 'Placas de Video', 'placas/video');
